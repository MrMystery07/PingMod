...
public class GuiCommandBlock extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.doneBtn = new UIButton(0, this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(this.cancelBtn = new UIButton(1, this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(this.field_175390_s = new UIButton(4, this.width / 2 + 150 - 20, 150, 20, 20, "O"));
