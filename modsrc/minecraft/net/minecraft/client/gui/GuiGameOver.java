...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        if (this.mc.theWorld.getWorldInfo().isHardcoreModeEnabled())
        {
            ...
            {
                this.buttonList.add(new UIButton(1, this.width / 2 - 100, this.height / 4 + 96, I18n.format("deathScreen.deleteWorld", new Object[0])));
            }
            else
            {
                this.buttonList.add(new UIButton(1, this.width / 2 - 100, this.height / 4 + 96, I18n.format("deathScreen.leaveServer", new Object[0])));
            }
        }
        else
        {
            this.buttonList.add(new UIButton(0, this.width / 2 - 100, this.height / 4 + 72, I18n.format("deathScreen.respawn", new Object[0])));
            this.buttonList.add(new UIButton(1, this.width / 2 - 100, this.height / 4 + 96, I18n.format("deathScreen.titleScreen", new Object[0])));
