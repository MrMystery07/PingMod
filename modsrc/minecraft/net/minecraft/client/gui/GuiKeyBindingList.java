...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        private KeyEntry(KeyBinding p_i45029_2_)
        {
            ...
            this.btnChangeKeyBinding = new UIButton(0, 0, 0, 75, 18, I18n.format(p_i45029_2_.getKeyDescription(), new Object[0]));
            this.btnReset = new UIButton(0, 0, 0, 50, 18, I18n.format("controls.reset", new Object[0]));
        }
