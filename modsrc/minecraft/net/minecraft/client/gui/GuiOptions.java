...
import net.pingmod.settings.GuiPingModSettings;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        if (this.mc.theWorld != null)
        {
            ...
            this.field_175357_i = new UIButton(108, this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 - 12 + 24 * (var1 >> 1), 150, 20, this.func_175355_a(var7));
        ...
        this.buttonList.add(new UIButton(103, this.width / 2 + 5, this.height / 6 + 120 - 6, 150, 20, I18n.format("options.multiplayer.title", new Object[0])));
        ...
        this.buttonList.add(new UIButton(201, this.width / 2 + 5, this.height / 6 - 6 + 24,150, 20, "PingMod Einstellungen"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            if(button.id == 201) {
            	this.mc.displayGuiScreen(new GuiPingModSettings());
            }
        }
    }
