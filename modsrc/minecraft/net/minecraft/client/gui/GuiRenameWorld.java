...
public class GuiRenameWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new UIButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, I18n.format("selectWorld.renameButton", new Object[0])));
        this.buttonList.add(new UIButton(1, this.width / 2 - 100, this.height / 4 + 120 + 12, I18n.format("gui.cancel", new Object[0])));
