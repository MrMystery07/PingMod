...
public class GuiIngestServers extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new UIButton(1, this.width / 2 - 155, this.height - 24 - 6, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new UIButton(2, this.width / 2 + 5, this.height - 24 - 6, 150, 20, I18n.format("options.stream.ingest.reset", new Object[0])));
    }
