...
public class ServerList {
	...
	public void loadPublicServerList() {
		try {
			this.servers.clear();
			
			ResourceLocation res = new ResourceLocation("/PingMod/servers.dat");
			
			NBTTagCompound nbttagcompound = CompressedStreamTools
					.read(new File(PingMod.minecraftPath + "/PingMod", "servers.dat"));
	...
	public void saveServerList() {
		if (GuiMultiplayer.selectedList == 0) {
			try {
