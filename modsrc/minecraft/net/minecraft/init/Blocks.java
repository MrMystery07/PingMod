...
public class Blocks {
	...
	public static List<Block> pingmodBlocks = new ArrayList<Block>();
	...
	static {
		if (!Bootstrap.isRegistered()) {
			...
			for (int i = 0; i < BlockManager.blocks.size(); i++) {
				pingmodBlocks.add((Block) Block.blockRegistry
						.getObject(new ResourceLocation(BlockManager.blocks.get(i).toString())));
			}
		}
	}
}
