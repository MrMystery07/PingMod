...
public abstract class GuiSlotInventory
{
    ...
    public GuiSlotInventory(Minecraft mcIn, int width, int height, int p_i1052_4_, int p_i1052_5_, int p_i1052_6_)
    {
        this.mc = mcIn;
        this.width = width;
        this.height = height;
    ...
    public void drawScreen(int p_148128_1_, int p_148128_2_, float p_148128_3_)
    {
        if (this.field_178041_q)
        {
            ...
            if (var12 > 0)
            {
                ...
                var7.startDrawingQuads();
                var7.func_178974_a(0, 255);
                var7.addVertexWithUV((double)var4 - 340, (double)this.bottom, 0.0D, 0.0D, 1.0D);
                var7.addVertexWithUV((double)var5 - 340, (double)this.bottom, 0.0D, 1.0D, 1.0D);
                var7.addVertexWithUV((double)var5 - 340, (double)this.top, 0.0D, 1.0D, 0.0D);
                var7.addVertexWithUV((double)var4 - 340, (double)this.top, 0.0D, 0.0D, 0.0D);
                var6.draw();
                var7.startDrawingQuads();
                var7.func_178974_a(8421504, 255);
                var7.addVertexWithUV((double)var4 - 340, (double)(var14 + var13), 0.0D, 0.0D, 1.0D);
                var7.addVertexWithUV((double)var5 - 340, (double)(var14 + var13), 0.0D, 1.0D, 1.0D);
                var7.addVertexWithUV((double)var5 - 340, (double)var14, 0.0D, 1.0D, 0.0D);
                var7.addVertexWithUV((double)var4 - 340, (double)var14, 0.0D, 0.0D, 0.0D);
                var6.draw();
                var7.startDrawingQuads();
                var7.func_178974_a(12632256, 255);
                var7.addVertexWithUV((double)var4 - 340, (double)(var14 + var13 - 1), 0.0D, 0.0D, 1.0D);
                var7.addVertexWithUV((double)(var5 - 1 - 340), (double)(var14 + var13 - 1), 0.0D, 1.0D, 1.0D);
                var7.addVertexWithUV((double)(var5 - 1 - 340), (double)var14, 0.0D, 1.0D, 0.0D);
                var7.addVertexWithUV((double)var4 - 340, (double)var14, 0.0D, 0.0D, 0.0D);
                var6.draw();
            }
    ...
    protected void drawSelectionBox(int p_148120_1_, int p_148120_2_, int p_148120_3_, int p_148120_4_)
    {
        ...
        for (int var8 = 0; var8 < var5; ++var8)
        {
            ...
            if (this.showSelectionBox && this.isSelected(var8))
            {
                ...
                var7.addVertexWithUV((double)var12-59, (double)(var9 + var10 + 2), 0.0D, 1.0D, 1.0D);
                var7.addVertexWithUV((double)var12-59, (double)(var9 - 2), 0.0D, 1.0D, 0.0D);
                ...
                var7.addVertexWithUV((double)(var12 - 60), (double)(var9 + var10 + 1), 0.0D, 1.0D, 1.0D);
                var7.addVertexWithUV((double)(var12 - 60), (double)(var9 - 1), 0.0D, 1.0D, 0.0D);
    ...
    protected void overlay1() {
    	///Gui.drawRect(0, this.height, this.width, this.bottom, new Color(0, 0, 236).getRGB());
		for (int i = 0; i < 170; i++) {
			Gui.drawRect(0 + i, this.height, this.width, this.bottom,
					new Color(i, i, 236).getRGB());
		}
    	
    	Gui.drawRect(0, 0, this.width, this.top, new Color(0, 0, 236).getRGB());
    }
