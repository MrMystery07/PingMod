...
public class AddonLoader {
	...
	public static void loadAddons() throws Exception {
		File ordner = new File("C:/Users/cziep/AppData/Roaming/.minecraft/PingMod/addons-1.8.8/");
		ordner.mkdir();
		...
		for (String name : dateiname) {
			...
			URL jarURL = new File("C:/Users/cziep/AppData/Roaming/.minecraft/PingMod/addons-1.8.8/" + orginalname).toURL();
