...
import net.pingmod.utils.BlockManager;
import net.pingmod.utils.PingMod;
import net.pingmod.utils.PingModAddonManager;
import net.pingmod.utils.PingModBlock;
...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        PingMod.initClient();
        PingModAddonManager.onBlockRegister();
        
        for(int i = 0; i < BlockManager.blocks.size(); i++) {
        	registerBlock(BlockManager.count, BlockManager.blocks.get(i), new PingModBlock(Material.wood, true).setHardness(0.3F).setUnlocalizedName(BlockManager.blocks.get(i)).setCreativeTab(CreativeTabs.tabPingMod));
        	BlockManager.count++;
        }
