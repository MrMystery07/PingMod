...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new UIButton(0, this.width / 2 - 100, var3 + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new UIButton(4, this.width / 2 + 2, var3 + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
    ...
    {
        this.buttonList.add(new UIButton(1, this.width / 2 - 100, p_73969_1_ - 25, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new UIButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1 - 25, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(new UIButton(100, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2 - 25, "Shop"));
        this.buttonList.add(this.field_175372_K = new UIButton(14, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 3 - 25, 98, 20, "Realms"));
        this.buttonList.add(new UIButton(101, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 3 - 25, 98, 20, "Inventar"));
        
        if(UpdateAviable.update) {
        	this.buttonList.add(new UIButton(110, 4, 4, 72, 20, "Aktualisieren"));
        }
    ...
    private void addDemoButtons(int p_73972_1_, int p_73972_2_)
    {
        ...
        this.buttonList.add(this.buttonResetDemo = new UIButton(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.format("menu.resetdemo", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if(button.id == 101) {
        	this.mc.displayGuiScreen(new GuiInventoryMenuAll());
        }
        if(button.id == 100) {
...
//        GlStateManager.popMatrix();
        ...
        String s = "PingMod 0.0.1 + build." + String.valueOf(PingMod.buildNumber);
//
//        if (this.mc.isDemo())
//        {
//            s = s + " Demo";
//        }
//
        this.drawString(this.fontRendererObj, s2, 2, this.height - 20, -1);
        this.drawString(this.fontRendererObj, s, 2, this
        		.height - 10, -1);
