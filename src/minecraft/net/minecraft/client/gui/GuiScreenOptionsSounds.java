    ...
    class Button extends GuiButton
    {
        ...
        protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
        {
            if (this.visible)
            {
                ...
                Gui.drawRect(this.xPosition + (int)(this.field_146156_o * (float)(this.width - 8)), this.yPosition, this.xPosition + (int)(this.field_146156_o * (float)(this.width - 8)) + 5, this.yPosition+20, new Color(43, 203, 186).getRGB());
            }
        }
