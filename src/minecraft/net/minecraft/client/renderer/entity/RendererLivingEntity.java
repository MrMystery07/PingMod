...
public abstract class RendererLivingEntity extends Render
{
    ...
    public void renderNameTag(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_, double p_77033_6_)
    {
    	if(p_77033_1_ == Minecraft.getMinecraft().thePlayer) {
            double var8 = p_77033_1_.getDistanceSqToEntity(this.renderManager.livingPlayer);
            float var10 = p_77033_1_.isSneaking() ? 32.0F : 64.0F;
...
//        this.renderNameTag((EntityLivingBase)p_177067_1_, p_177067_2_, p_177067_4_, p_177067_6_);
    }
