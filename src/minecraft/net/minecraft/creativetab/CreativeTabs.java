...
public abstract class CreativeTabs
{
    ...
    public static final CreativeTabs tabBrewing = new CreativeTabs(3, "brewing")
    {
    ...
    public static final CreativeTabs tabMaterials = new CreativeTabs(9, "materials")
    {
    ...
    public static final CreativeTabs tabPingMod = new CreativeTabs(10, "pingmod")
    {
