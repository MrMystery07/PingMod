...
public class CosmeticCape implements LayerRenderer
{
    ...
    public static AnimatedResourceLocation ar;

    public CosmeticCape(RenderPlayer p_i46123_1_)
    {
    ...
    public void doRenderLayer(AbstractClientPlayer p_177166_1_, float p_177166_2_, float p_177166_3_, float p_177166_4_, float p_177166_5_, float p_177166_6_, float p_177166_7_, float p_177166_8_)
    {
        ...
        {
        	if(Controller.cape) {
        	if(p_177166_1_.getName().equalsIgnoreCase(Minecraft.getMinecraft().thePlayer.getName()))
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        
        	
        	ar.update();
            this.playerRenderer.bindTexture(ar.getTexture());
            ...
            this.playerRenderer.func_177136_g().renderAnimatedCape(0.0625F);
